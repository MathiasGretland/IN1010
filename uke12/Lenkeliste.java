...
class Lenkeliste<T> implements Liste<T>{
    ...
    public int stoerrelseRek(Node node){
        if (node == null){
            return 0;
        }
        return 1 + stoerrelseRek(node.neste);
    }

    public int stoerrelseRekursivt(){
        return stoerrelseRek(start);
    }
    ...
    public void skrivUt(){
        Node hentNeste = start;
        while (hentNeste != null){
            System.out.println(hentNeste.data);
            hentNeste = hentNeste.neste;
        }
    }

    public void skrivUtRekursivt(){
        skrivUtRekursivt(start);
    }

    public void skrivUtRekursivt(Node n){
        if (n == null){
            return;
        }
        System.out.println(n.data);

        skrivUtRekursivt(n.neste);

    }

    public void skrivUtRekursivtBaklengs(){
        skrivUtRekursivtBaklengs(start);
    }

    public void skrivUtRekursivtBaklengs(Node n){
        if (n == null){
            return;
        }

        skrivUtRekursivtBaklengs(n.neste);
